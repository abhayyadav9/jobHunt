...
const CompanySetup = () => {
    ...
    const validateInputs = () => input.name && input.website && input.location;
    ...
    const submitHandler = async (e) => {
        ...
        Object.entries(input).forEach(([key, value]) => value && formData.append(key, value));
                ...
                <form onSubmit={submitHandler}>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                        ...
                        <div>
                            ...
                            {filePreview && <img src={filePreview} alt="Preview" className="h-20 w-20 my-2" />}
                        </div>
                    </div>
                    {loading ? (
